   ...
   <body>
        ...
        <div class="container">
                ...
                <div class="tit-5 container ">
                    ...
                    <h1 class="tit mt-5 display-3 animate__animated animate__flipInX" style="font-size :8rem !important;">Hola! Soy Andres Vitale   <br></h1>
                    <p class="tit-2 lead animate__animated animate__flipInX" style="font-size :3rem !important; color:grey!important;">FullStack Sotfware Developer Jr.</p>
                        ...
                        <div class="card border border-3 shadow w-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-dark">
                                 ...
                                 <a href="<?php #echo $proyecto['url'];?>"><i class="bi bi-link-45deg"></i></a>
                                 <a href="<?php #echo $proyecto['url_github'];?>"><i class="bi bi-github"></i></a>
    ...
    <footer>
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">Diseñado por Andres Vitale</a>
            </li>
